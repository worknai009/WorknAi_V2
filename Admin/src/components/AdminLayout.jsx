...
import {
  LayoutDashboard, Users, BookOpen, Briefcase, Package,
  Handshake, Building2, MessageSquare, FileText, ClipboardList,
  UserCircle, LogOut
} from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-slate-950">
      ...
      <aside className="w-60 shrink-0 border-r border-slate-800 bg-slate-900 flex flex-col">
        <div className="px-6 py-5 border-b border-slate-800">
          ...
          <span className="ml-2 text-xs font-medium text-violet-400 bg-violet-500/10 px-2 py-0.5 rounded-full">Admin</span>
        </div>
